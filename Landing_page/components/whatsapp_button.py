...
whatsapp_message = "¡Hola! Estoy interesado en más información sobre las casas."
...
def whatsapp_button():
    return rx.fragment(
        rx.desktop_only(
            whatsapp_button_desktop()  # Solo mostrar en desktop
        ),
        rx.mobile_and_tablet(
            whatsapp_button_mobile()  # Solo mostrar en mobile/tablet
        )
    )
